...
def create_shortest_path_data(m, train_size, test_size, context_size):
    ...
    for context in enumerate(Context):
        ...
        # Enocde edge description of shortest path as a vector
    ...
    train_dataset_v, test_dataset_v = random_split(dataset_v, [train_size, test_size])
    train_dataset_e, test_dataset_e = random_split(dataset_e, [train_size, test_size])
